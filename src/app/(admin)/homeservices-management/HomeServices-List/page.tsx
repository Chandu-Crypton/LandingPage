...
const ServiceListPage: React.FC = () => {
    const { services, deleteService } = useHomeServices();
    ...
    const filteredServices = useMemo(() => {
        ...
        return services.filter((service) => {
            ...
            if (service.description?.toLowerCase().includes(lowercasedSearchTerm)) return true;
                ...
                {loading ? (
                    ...
                    <div className="overflow-x-auto">
                        <table className="min-w-full text-sm">
                            ...
                            <tbody>
                                {filteredServices.map((service: IHomeServices) => (
                                    <tr key={service._id as string} className="border-t hover:bg-gray-50 transition">
                                        ...
                                        <td className="px-5 py-3">
                                            <div className="flex justify-center gap-2">
                                                <Link
                                                    href={`/homeservices-management/HomeServices-List/${service._id as string}`}
