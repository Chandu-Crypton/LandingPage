...
const DepartmentBoardComponent = dynamicImport(
  () => import('@/components/departmentboard-component/DepartmentBoardComponent'),
  { ssr: false }
);
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="bg-white p-6 rounded shadow mb-10">
        ...
        <DepartmentBoardComponent boardIdToEdit={boardId} />
      </div>
    </div>
  );
};
