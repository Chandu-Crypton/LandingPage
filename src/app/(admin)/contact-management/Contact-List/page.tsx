...
const ContactListPage: React.FC = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <ComponentCard title="Contact List" className="overflow-visible">
        {!loading ? (
          <>
            ...
            >
                 ...
                 <table className="min-w-max border border-gray-200 rounded-lg text-sm">
                <thead className="bg-gray-100 text-gray-700 text-left">
                  <tr>
                    <th className="px-4 py-3 whitespace-nowrap sticky left-0 bg-gray-100 z-10">Full Name</th>
                    <th className="px-4 py-3 whitespace-nowrap">HrEmail</th>
                    <th className="px-4 py-3 whitespace-nowrap">SalesEmail</th>
                    <th className="px-4 py-3 whitespace-nowrap">HR Number</th>
                    <th className="px-4 py-3 whitespace-nowrap">Sales Number</th>
                    <th className="px-4 py-3 whitespace-nowrap">Company Number</th>
                    <th className="px-4 py-3 whitespace-nowrap">Message</th>
                    <th className="px-4 py-3 whitespace-nowrap">Contact History</th>
                    <th className="px-4 py-3 whitespace-nowrap sticky right-0 bg-gray-100 z-10 text-center">Actions</th>
                  </tr>
                </thead>
                <tbody>
                  {filteredContacts.length > 0 ? (
                    filteredContacts.map((entry, idx) => (
                      ...
                      >
                        <td className="px-4 py-3 whitespace-nowrap sticky left-0 bg-white z-5 font-medium">{entry.fullName}</td>
                        <td className="px-4 py-3 break-words max-w-[150px]">{entry.hremail}</td>
                        <td className="px-4 py-3 break-words max-w-[150px]">{entry.salesemail}</td>
                        <td className="px-4 py-3 whitespace-nowrap">{entry.hrNumber}</td>
                        <td className="px-4 py-3 whitespace-nowrap">{entry.salesNumber}</td>
                        ...
                        <td className="px-4 py-3 sticky right-0 bg-white z-5">
                          <div className="flex justify-center gap-2">
                            <Link
                              href={`/contact-management/Contact-List/${entry._id}`}
                              className="p-2 rounded-md border border-blue-500 text-blue-500 hover:bg-blue-500 hover:text-white transition-colors"
                              title="View"
                            >
                              <EyeIcon size={16} />
                            </Link>
                            <Link
                              href={`/contact-management/Add-Contact?page=edit&id=${entry._id}`}
                              className="p-2 rounded-md border border-yellow-500 text-yellow-500 hover:bg-yellow-500 hover:text-white transition-colors"
                              title="Edit"
                            >
                              <PencilIcon size={16} />
                            </Link>
