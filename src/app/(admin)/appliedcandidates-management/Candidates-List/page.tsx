                        ...
                        <table className="w-full text-xs lg:text-sm table-fixed border-collapse">
                            <thead>
                                <tr className="text-gray-600">
                                    ...
                                    <th className="px-2 py-2 w-[12%] text-left">Job Title</th>
                                    <th className="px-2 py-2 w-[14%] text-left">Email</th>
                                    {/* <th className="px-2 py-2 w-[10%] text-left">Phone</th> */}
                                    <th className="px-2 py-2 w-[10%] text-left">Applied On</th>
                                    <th className="px-2 py-2 w-[10%] text-left">Location</th>
                                    <th className="px-2 py-2 w-[10%] text-left">Workplace Type</th>
                                    <th className="px-2 py-2 w-[10%] text-left">Employment Type</th>
                            ...
                            <tbody>
                                {filteredCandidates.map((candidate) => (
                                    <tr key={candidate._id} className="border-t hover:bg-gray-50 transition">
                                        <td className="px-2 py-2 truncate" title={candidate.fullName}>
                                            {candidate.fullName}
                                        </td>
                                        <td className="px-2 py-2 truncate" title={candidate.title}>
                                            {candidate.title}
                                        </td>
                                        <td className="px-2 py-2 truncate" title={candidate.email}>
                                            {candidate.email}
                                        </td>
                                        ...
                                        <td className="px-2 py-2 truncate" title={candidate.location}>
                                            {candidate.location}
                                        </td>
                                        <td className="px-2 py-2 truncate" title={candidate.workplacetype}>
                                            {candidate.workplacetype}
                                        </td>
                                        <td className="px-2 py-2 truncate" title={candidate.employmenttype}>
