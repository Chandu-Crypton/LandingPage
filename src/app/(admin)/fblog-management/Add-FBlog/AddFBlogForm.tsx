...
const FBlogComponent = dynamicImport(
  () => import('@/components/fblog-component/FBlogComponent'),
  { ssr: false }
);

const AddFBlogForm: React.FC = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="bg-white p-6 rounded shadow mb-10">
        ...
        <FBlogComponent blogIdToEdit={blogId} />
      </div>
    </div>
  );
};

export default AddFBlogForm;