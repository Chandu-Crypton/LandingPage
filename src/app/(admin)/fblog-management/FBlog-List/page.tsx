...
const BlogListPage: React.FC = () => {
    const { blogs, deleteBlog } = useFBlog();
    ...
    return blogs.filter((blog) => {
        ...
        if(blog.blogHeading.toLowerCase().includes(lowercasedSearchTerm)) return true;
            ...
            <div className="flex flex-col lg:flex-row gap-6 mb-8">
                <div className="w-full lg:w-3/4">
                    <ComponentCard title="Search Filter">
                        <div className="py-3">
                            <Label htmlFor="searchBlogs">Search by Title/BlogHeading/Category/Description</Label>
                            <Input
                                id="searchBlogs"
                                type="text"
                                    ...
                                    <tr key={blog._id as string} className="border-t hover:bg-gray-50 transition">
                                        ...
                                        <td className="px-5 py-3">
                                            <div className="flex justify-center gap-2">
                                                <Link
                                                    href={`/fblog-management/FBlog-List/${blog._id as string}`}
