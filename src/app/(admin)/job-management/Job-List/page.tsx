            ...
            <table className="w-full text-xs lg:text-sm table-fixed border-collapse">
              <thead>
                <tr className="text-gray-600">
                  <th className="px-2 py-2 w-[12%] text-left">Title</th>
                  <th className="px-2 py-2 w-[10%] text-left">Department</th>
                  <th className="px-2 py-2 w-[10%] text-left">Location</th>
                  <th className="px-2 py-2 w-[8%] text-left">Salary</th>
                  <th className="px-2 py-2 w-[10%] text-left">Experience</th>
                  <th className="px-2 py-2 w-[12%] text-left">Qualification</th>
                  <th className="px-2 py-2 w-[10%] text-left">Deadline</th>
                  <th className="px-2 py-2 w-[10%] text-left">Opening</th>
                  <th className="px-2 py-2 w-[8%] text-left">Job Type</th>
              ...
              <tbody>
                {filteredJobs.map((job) => (
                  ...
                  >
                    <td className="px-2 py-2 truncate" title={job.title}>
                      {job.title}
                    </td>
                    <td className="px-2 py-2 truncate" title={job.department}>
                      {job.department}
                    </td>
                    <td className="px-2 py-2 truncate" title={job.location}>
                      {job.location}
                    </td>
                    <td className="px-2 py-2">{job.salary}</td>
                    <td className="px-2 py-2">{job.experience}</td>
                    <td className="px-2 py-2 truncate" title={job.qualification}>
                      {job.qualification}
                    </td>
                    <td className="px-2 py-2">
                      {new Date(job.applicationDeadline).toLocaleDateString()}
                    </td>
                    <td className="px-2 py-2 truncate">{job.openingType}</td>
                    <td className="px-2 py-2 truncate">{job.jobType}</td>
                    <td className="px-2 py-2">
